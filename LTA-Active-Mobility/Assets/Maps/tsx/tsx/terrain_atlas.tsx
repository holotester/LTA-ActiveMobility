...
<tileset version="1.10" tiledversion="1.10.1" name="terrain_atlas" tilewidth="32" tileheight="32" tilecount="1024" columns="32">
 <editorsettings>
  <export target="terrain_atlas.tsx" format="tsx"/>
 </editorsettings>
 <image source="../../png/terrain_atlas.png" width="1024" height="1024"/>
 <wangsets>
